...
char* ssid = "Alohomora";  //  your network SSID (name)
char* pass = "unlockth3world";       // your network password
...
AccelStepper stepper(1,23, 19);// direction Digital 19 (CCW), pulses Digital 23 (CLK)
const byte interruptPin = 3; //pin for the microswitch using attachInterrupt(); 
